export const portfolioData = [
    ...
    },  
    {
        ...
        "challenges":"This was my first React app. The requirements demanded many moving parts.",
        "fun":"This was a challenging first React app to build but very satisfying when I completed it.",
...

    {
        ...
        "challenges":"Only a flat desktop design was handed off. Animations and interactivity was left for me to design and code.",
    ...
    },
    {
        ...
        "challenges":"The post type needed to be handed off to a non-technical admin, so a simple, yet robust design was essential to ensure the site couldn't break during edits. Since content length, image sizes, and locations were not defined during development, these factors had to be accounted for in the development.",
